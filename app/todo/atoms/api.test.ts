...
describe('Todo API', () => {
  ...
  describe('listsApi', () => {
    it('should get all lists', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists', {
    ...
    it('should update a list', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/1', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('tasksApi', () => {
    it('should get tasks by list', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/tasks', {
        headers: { 'Content-Type': 'application/json' },
      });
    ...
    it('should update a task', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/tasks/1', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(updateData),
      });
    ...
    it('should toggle a task', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/tasks/1/toggle', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      });
      expect(result).toEqual(mockResponse);
    ...
    it('should reorder tasks', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/tasks/reorder', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  describe('itemsApi', () => {
    it('should get shopping items by list', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/items', {
        headers: { 'Content-Type': 'application/json' },
      });
    ...
    it('should update a shopping item', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/items/1', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(updateData),
      });
    ...
    it('should toggle a shopping item', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/items/1/toggle', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
      });
      expect(result).toEqual(mockResponse);
    ...
    it('should reorder shopping items', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/lists/list1/items/reorder', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ item_ids: itemIds }),
      });
  ...
  describe('searchApi', () => {
    it('should search across all content', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith('http://localhost:8000/api/search?q=test', {
        headers: { 'Content-Type': 'application/json' },
      });
